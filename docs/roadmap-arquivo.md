# ARQUIVO — ROADMAP (fases 1–5 concluídas)

> Este arquivo guarda o detalhamento original (com trechos de código) das
> fases **1 a 5**, já concluídas. Foi separado do `ROADMAP.md` para deixar o
> roadmap principal leve — o `ROADMAP.md` mantém apenas um resumo dessas fases
> e o detalhamento da fase ativa. Consulte aqui se precisar do passo a passo
> histórico. A fonte da verdade do que está em produção é sempre o código.
